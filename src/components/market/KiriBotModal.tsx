...
export default function KiriBotModal({ onClose }: KiriBotModalProps) {
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 h-[100dvh] sm:h-auto sm:inset-auto sm:bottom-24 sm:right-6 z-[100] flex flex-col justify-end sm:block p-0 pointer-events-none transition-all duration-300">
        {/* 모바일 바텀시트 or 우측 하단 플로팅 챗봇(PC) 디자인 */}
        <div
          className="w-full sm:w-[380px] h-[85%] sm:h-[600px] bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl sm:border sm:border-gray-100 flex flex-col overflow-hidden animate-in slide-in-from-bottom-full duration-300 pointer-events-auto"
