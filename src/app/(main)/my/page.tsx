  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-4">
        {MENU_ITEMS.map(({ href, icon: Icon, label }, i) => (
          <div key={href}>
            ...
            >
              <Image src="/images/logo/raccoon-mascot-logo-sm.png" alt="logo" width={18} height={18} className="w-[18px] h-[18px] object-contain shrink-0" />
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-4">
        ...
        >
          <Image src="/images/logo/raccoon-mascot-face.png" alt="logo" width={25} height={25} className="w-[25px] h-[25px] object-contain shrink-0" />
        ...
        >
          <Image src="/images/logo/judy-face2.png" alt="logo" width={30} height={30} className="w-[30px] h-[30px] object-contain shrink-0" />
      ...
      <footer className="mt-6 mb-8 px-2">
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2 grayscale opacity-60">
            <Image src="/images/logo/raccoon-mascot-logo-sm.png" alt="logo" width={20} height={20} className="w-[20px] h-[20px] object-contain shrink-0" />
